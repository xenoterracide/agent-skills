...
// Immutables datatype module generates type-safe field constants (User_.NAME, User_.AGE)
assertThat(user)
    .hasFieldOrPropertyWithValue(User_.NAME, "Alice")
    .hasFieldOrPropertyWithValue(User_.AGE, 30);
```
